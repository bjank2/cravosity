        ...
        <div className="MyDiningGroups">
            <div className="content">
                <header className="header">
                    ...
                    <button onClick={() => onNavigate('GroupDining')} className="orange-button">New Group</button>
                </header>
                ...
                <div className="group-list">
                    {groups.map((group, index) => (
                        <div
                            className={`group-item ${selectedGroup === index ? 'selected' : ''}`}
                            key={index}
                ...
                <div className="button-container">
                    <button onClick={() => onNavigate('GroupDining')} className="orange-button">Confirm Group</button>
                    <button onClick={() => onNavigate('Home')} className="orange-button">Cancel</button>
                </div>
            </div>
        </div>
    );
